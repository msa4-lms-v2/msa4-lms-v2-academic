...
class ProfessorLectureOpenApiTest extends MySqlIntegrationTest {

    @Autowired
    private MockMvc mockMvc;

    @Test
    void generatedOpenApiContainsProfessorLectureContract() throws Exception {
        ...
        mockMvc.perform(get("/api-docs"))
                ...
                .andExpect(jsonPath("$['components']['schemas']['ProfessorLectureResponseDTO']"
                        + "['properties']['classId']").exists())
                .andExpect(jsonPath("$['components']['schemas']['ProfessorLectureResponseDTO']"
                        + "['properties']['currentEnrollmentCount']").exists())
                .andExpect(jsonPath("$['components']['schemas']['ProfessorLectureResponseDTO']"
