...
public class EnrollmentCartController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "E21: 잘못된 학년도 또는 학기 조건",
            ...
            @ApiResponse(responseCode = "401", description = "E02/E04: 미인증 또는 잘못된 인증 정보",
                    content = @Content(schema = @Schema(implementation = GlobalResponseDTO.class))),
            @ApiResponse(responseCode = "403", description = "E03: 학생 외 역할의 조회",
                    content = @Content(schema = @Schema(implementation = GlobalResponseDTO.class))),
            @ApiResponse(responseCode = "404", description = "E10: 본인 학생 정보 없음",
                    content = @Content(schema = @Schema(implementation = GlobalResponseDTO.class)))
    })
    @GetMapping
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "E21: 필수 lectureId 누락 또는 형식 오류",
                    content = @Content(schema = @Schema(implementation = GlobalResponseDTO.class))),
            @ApiResponse(responseCode = "401", description = "E02/E04: 미인증 또는 잘못된 인증 정보",
                    content = @Content(schema = @Schema(implementation = GlobalResponseDTO.class))),
            @ApiResponse(responseCode = "403", description = "E03: 학생 외 역할의 추가",
                    content = @Content(schema = @Schema(implementation = GlobalResponseDTO.class))),
            @ApiResponse(responseCode = "404", description = "E10: 본인 학생 또는 대상 강의 없음",
                    content = @Content(schema = @Schema(implementation = GlobalResponseDTO.class))),
            @ApiResponse(responseCode = "409", description = "E11: 기간·학적·강의 상태 또는 중복 충돌",
                    content = @Content(schema = @Schema(implementation = GlobalResponseDTO.class)))
    })
    @PostMapping
    @PreAuthorize("hasRole('STUDENT')")
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "E21: 장바구니 항목 ID 형식 오류",
                    content = @Content(schema = @Schema(implementation = GlobalResponseDTO.class))),
            @ApiResponse(responseCode = "401", description = "E02/E04: 미인증 또는 잘못된 인증 정보",
                    content = @Content(schema = @Schema(implementation = GlobalResponseDTO.class))),
            @ApiResponse(responseCode = "403", description = "E03: 학생 외 역할의 삭제",
                    content = @Content(schema = @Schema(implementation = GlobalResponseDTO.class))),
            @ApiResponse(responseCode = "404", description = "E10: 본인 장바구니 항목 또는 학생 정보 없음",
                    content = @Content(schema = @Schema(implementation = GlobalResponseDTO.class))),
            @ApiResponse(responseCode = "409", description = "E11: 수강신청 기간 밖의 변경",
                    content = @Content(schema = @Schema(implementation = GlobalResponseDTO.class)))
    })
