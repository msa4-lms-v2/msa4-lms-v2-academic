...
public class ProfessorInfoChangeRequestController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "401", description = "인증 실패",
                    content = @Content(schema = @Schema(implementation = GlobalRes.class))),
            @ApiResponse(responseCode = "403", description = "PROFESSOR 또는 ADMIN 권한 필요",
                    content = @Content(schema = @Schema(implementation = GlobalRes.class)))
    })
    @GetMapping
    @PreAuthorize("hasAnyRole('PROFESSOR', 'ADMIN')")
    public ResponseEntity<GlobalRes<PageRes<ProfessorInfoChangeRequestResponseDTO>>> search(
    ...
    @PreAuthorize("hasAnyRole('PROFESSOR', 'ADMIN')")
    public ResponseEntity<GlobalRes<ProfessorInfoChangeRequestResponseDTO>> get(
    ...
    public ResponseEntity<GlobalRes<ProfessorInfoChangeRequestResponseDTO>> create(
    ...
    public ResponseEntity<GlobalRes<ProfessorInfoChangeRequestResponseDTO>> approve(
            @Positive @PathVariable Long requestId,
            @Parameter(hidden = true) @AuthenticationPrincipal CurrentUser currentUser,
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<GlobalRes<ProfessorInfoChangeRequestResponseDTO>> reject(
            @Positive @PathVariable Long requestId,
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "401", description = "인증 실패",
                    content = @Content(schema = @Schema(implementation = GlobalRes.class))),
            @ApiResponse(responseCode = "403", description = "본인 신청이 아니거나 PROFESSOR 권한 없음",
                    content = @Content(schema = @Schema(implementation = GlobalRes.class))),
            @ApiResponse(responseCode = "404", description = "신청 없음",
                    content = @Content(schema = @Schema(implementation = GlobalRes.class))),
            @ApiResponse(responseCode = "409", description = "처리 상태 충돌",
    ...
    @PreAuthorize("hasRole('PROFESSOR')")
    public ResponseEntity<GlobalRes<ProfessorInfoChangeRequestResponseDTO>> cancel(
            @Positive @PathVariable Long requestId,
            @Parameter(hidden = true) @AuthenticationPrincipal CurrentUser currentUser,
            @RequestHeader(value = "X-Request-Id", required = false) String traceRequestId,
            @Parameter(hidden = true) HttpServletRequest httpServletRequest
