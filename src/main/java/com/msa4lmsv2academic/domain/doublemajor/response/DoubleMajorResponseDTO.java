...
public record DoubleMajorResponseDTO(
        ...
        @Schema(description = "신청 당시 주전공 ID, 미배정이면 null", example = "1") Long sourceMajorId,
        @Schema(description = "신청 당시 주전공명, 미배정이면 null", example = "소프트웨어전공") String sourceMajorName,
        @Schema(description = "희망 복수전공 소속 학과 ID", example = "249") Long targetDepartmentId,
        @Schema(description = "희망 복수전공 소속 학과명", example = "경영학과") String targetDepartmentName,
        @Schema(description = "희망 복수전공 ID", example = "126") Long targetMajorId,
        @Schema(description = "희망 복수전공명", example = "경영학전공") String targetMajorName,
