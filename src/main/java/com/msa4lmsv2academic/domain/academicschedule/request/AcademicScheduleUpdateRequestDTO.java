...
@Schema(description = "학사일정 전체 수정 요청")
public record AcademicScheduleUpdateRequestDTO(
        @Schema(description = "일정 제목", example = "2026학년도 2학기 수강신청 변경",
        ...
        @Schema(description = "일정 상세 내용. 공백이면 null로 저장됩니다.",
                example = "변경된 신청 기간을 확인해 주세요.", maxLength = 5000, nullable = true)
        ...
        @Schema(description = "변경 사유", example = "수강신청 기간 연장", minLength = 1, maxLength = 255,
                requiredMode = Schema.RequiredMode.REQUIRED)
