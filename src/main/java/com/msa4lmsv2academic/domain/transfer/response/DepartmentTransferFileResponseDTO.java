...
public record DepartmentTransferFileResponseDTO(
        ...
        @Schema(description = "원본 파일명", example = "전과신청서.hwp") String originalName,
        @Schema(description = "MIME 타입", example = "application/x-hwp") String contentType,
    ...
    public static DepartmentTransferFileResponseDTO from(AcademicChangeRequestFile file) {
        return new DepartmentTransferFileResponseDTO(file.getId(), file.getOriginalName(),
