...
@Table(name = "professors", uniqueConstraints = @UniqueConstraint(name = "uk_professors_user_id", columnNames = "user_id"))
public class Professor {
    ...
    @Column(name = "hire_year", nullable = false) private short hireYear;
