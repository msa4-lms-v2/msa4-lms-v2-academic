...
@Table(
        ...
        uniqueConstraints = @UniqueConstraint(
                name = "uk_graduation_requirements_department_year",
                columnNames = {"department_id", "admission_year"}
        )
)
public class GraduationRequirement {
    ...
    @Column(name = "required_major_credits", nullable = false)
    private int requiredMajorCredits;

    @Column(name = "required_general_credits", nullable = false)
    private int requiredGeneralCredits;

    @Column(name = "required_total_credits", nullable = false)
    private int requiredTotalCredits;

    @JdbcTypeCode(SqlTypes.JSON)
    @Column(name = "required_courses", columnDefinition = "json")
    ...
    public static GraduationRequirement create(
            Department department,
            short admissionYear,
            int requiredMajorCredits,
            int requiredGeneralCredits,
