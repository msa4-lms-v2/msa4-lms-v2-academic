...
@Tag(name = "Counseling Records", description = "교수 상담 답변 및 온라인·대면 상담 기록 API")
@Validated
@RestController
...
public class CounselingRecordController {
    ...
    public ResponseEntity<GlobalRes<CounselingRecordResponseDTO>> createOnline(
        ...
        CounselingRecordResponseDTO response = counselingRecordService.createOnline(request, currentUser);
    ...
    public ResponseEntity<GlobalRes<PageRes<CounselingRecordSummaryResponseDTO>>> searchMyRecords(
        ...
        return ResponseEntity.ok(GlobalRes.success(counselingRecordService.searchMyRecords(request, currentUser)));
    }
    ...
    public ResponseEntity<GlobalRes<CounselingRecordResponseDTO>> getMyRecord(
        ...
        return ResponseEntity.ok(GlobalRes.success(counselingRecordService.getMyRecord(recordId, currentUser)));
    }
    ...
    public ResponseEntity<GlobalRes<PageRes<CounselingRecordSummaryResponseDTO>>> search(
        ...
        return ResponseEntity.ok(GlobalRes.success(counselingRecordService.search(request, currentUser)));
    }
    ...
    public ResponseEntity<GlobalRes<CounselingRecordResponseDTO>> get(
        ...
        return ResponseEntity.ok(GlobalRes.success(counselingRecordService.get(recordId, currentUser)));
    }
    ...
    public ResponseEntity<GlobalRes<CounselingRecordResponseDTO>> createInPerson(
        ...
        CounselingRecordResponseDTO response = counselingRecordService.createInPerson(request, currentUser);
        return ResponseEntity.status(HttpStatus.CREATED).body(GlobalRes.success(response));
    }
    ...
    public ResponseEntity<GlobalRes<CounselingRecordResponseDTO>> updateOnlineResponse(
        ...
        return ResponseEntity.ok(GlobalRes.success(
                counselingRecordService.updateOnlineResponse(recordId, request, currentUser)
        ));
    }
}
