...
public class CounselingRecordQueryRepository {
    ...
    public CounselingRecordSearchResult searchForStudent(StudentCounselingRecordSearchCondition condition) {
        QUser studentUser = new QUser("currentCounselingStudentUser");
        QUser professorUser = new QUser("studentCounselingProfessorUser");
    ...
    public Optional<CounselingRecord> findByIdForStudent(Long recordId, Long studentUserId) {
        QUser studentUser = new QUser("counselingDetailCurrentStudentUser");
        QUser professorUser = new QUser("counselingDetailAdvisorUser");
    ...
    public Optional<Student> findStudentWithAdvisorByUserId(Long studentUserId) {
        ...
        return Optional.ofNullable(jpaQueryFactory
                .selectFrom(student)
                .join(student.user, studentUser).fetchJoin()
                .leftJoin(student.advisor, professor).fetchJoin()
                .leftJoin(professor.user, advisorUser).fetchJoin()
